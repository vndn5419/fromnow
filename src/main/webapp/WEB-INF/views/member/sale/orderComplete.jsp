...
<style type="text/css">
.line{border-bottom:2px solid grey;
     border-top: 2px solid grey;}
td{
     height: 70px;
}
#countinue_shopping:hover{
...
$(function(){
   var animation = bodymovin.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        path: 'assets/js/animation-w500-h500.json'
   });
});
...
<%-- 							<c:if test="${category=='member'}">
        ...
        <!-- property area -->
        <div class="content-area user-profiel" style="margin-bottom: 100px;">
            <div class="container" style="padding-top: 50px; background-color: white;">   
            <div style="text-align: center;">
            <h3 class="page-title"style="border-bottom: solid 3px #FDC600; padding-bottom: 10px; color: #333; display: inline; letter-spacing: 0.198em; text-transform: uppercase;">Order Complete</h3>
            </div>            
                <div class="row" style="margin-top: 60px;">
                    <div class="col-sm-10 col-sm-offset-1 profiel-container">
            			<h2 align="center" style="margin-bottom: 50px; text-shadow: 2px 2px #ccc;">${userid}&nbsp;Thank you! for your order</h2>
      						<div id="bm" style="margin-top:10px; margin-bottom: 80px; margin-left: auto; margin-right: auto; width: 180px; height: 180px;"></div>
								<div style="width: 100%; padding-left: 200px;">
									<div style="font-weight: bold; font-size: x-large; text-shadow: 2px 2px #ccc;">Order Info</div>   
									<br><br>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">User id</div><div style="display: -webkit-inline-box;">${sale.userid}</div></div>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">User address</div><div style="display: -webkit-inline-box;">${sale.sale_country}&nbsp;${sale.sale_province}&nbsp;${sale.sale_city}&nbsp;${sale.sale_address1}&nbsp;${sale.sale_address2}</div></div>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">User phone</div><div style="display: -webkit-inline-box;">${sale.sale_phone}</div></div>
						      		<br>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">Project name</div><div style="display: -webkit-inline-box;">${project.project_title}</div></div>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">Purchase date</div><div style="display: -webkit-inline-box;">${sale.sale_date}</div></div>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">Purchase amount</div><div style="display: -webkit-inline-box;">${sale.sale_amount}</div></div>
						      		<div><div style="font-weight: bold; width: 18%; display: -webkit-inline-box;">Total price</div><div style="display: -webkit-inline-box;">${sale.sale_totalprice}</div></div>
								</div>
							      <br>
							      <br>
      							<div style="text-align: center;"><input id="countinue_shopping" type="button" style="color: white; background-color: #FDC600; width: 300px; height: 50px; margin-bottom: 50px;" onclick="location.href='${pageContext.request.contextPath}/'" value="countinue shopping"> </div>
	                </div>
	            </div>

...
<script type="text/javascript">
	$(function (){
		...
		//memberLogin 선택 후 admin 로그인
	   $("#memberLogin").on("click",function(){
	      var userid = $("#userid").val();
	      if($("#userid").val()=="admin"){
	         if($("#userpwd").val()=="admin"){
	          $.ajax({
	            method : 'post',
	            url : 'adminLogin',
	            data :  'userid='+userid,
	  ...
	  //companyLogin 선택 후 admin 로그인
      $("#companyLogin").on("click",function(){
         var userid = $("#co_id").val();
         if($("#co_id").val()=="admin") {
            if($("#co_pwd").val()=="admin"){
		          $.ajax({
		            method : 'post',
...
function memberClick(){
	...
	$("#member").css('background-color', '#FDC600');
	$("#companyLogin").hide();
	$("#memberLogin").show();		
}	
function companyClick(){
	$("#member").css('background-color', '');
	$("#company").css('background-color', '#FDC600');
	$("#memberLogin").hide();
	$("#companyLogin").show();	
}
</script>
...
<!-- 	<div class="page-head">
	...
	<div class="register-area"
		...
		<div class="container" style="margin-left: 400px;">
			<div class="col-md-6">
				<div class="box-for overflow" style="padding-top: 0px;">
					<div class="col-md-12 col-xs-12 member-login-blocks" id="member" style="width: 50%; height:40px; text-align: left; border: 0px;"><span style="height:40px; display: table-cell; vertical-align: middle;">Member</span></div>
					<div class="col-md-12 col-xs-12 company-login-blocks" id="company" style="width: 50%; height:40px; text-align: left; border: 0px;"><span style="height:40px; display: table-cell; vertical-align: middle;">Company</span></div>
						<div class="col-md-12 col-xs-12 login-blocks" id="memberLogin">
						<h2>Individual Member Login :</h2>
						<form action=memberLoginIn method="post">
							...
							<div class="text-center">
								<button id="memberLogin" type="submit" class="btn btn-default" style="color: white;">Member LogIn</button>
							</div>
						</form>
					</div>
					<div class="col-md-12 col-xs-12 login-blocks" id="companyLogin">
						<h2>Enterprise Member Login :</h2>
						<form action="companyLogIn" method="post">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" id="co_pwd" name="co_pwd">
							</div>
							<div class="text-center">
								<button id="companyLogin" type="submit" class="btn btn-default" style="color: white;">Company LogIn</button>
							</div>
						</form>
					</div>
				</div>

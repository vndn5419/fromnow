...
<%-- 							<c:if test="${category=='member'}">
	...
	<!-- property area -->
	<div class="content-area user-profiel" style="background-color: #FCFCFC; padding-top: 126px; padding-bottom: 126px;">
		&nbsp;
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1 profiel-container" style="background-color: white; padding-top: 0px;">

					<form action="" method="">

						<div class="profiel-header">
							<h3>
								<b>CHOOSE</b> JOIN MEMBER <br> <small>After Join
									us, you can use free</small>
							</h3>
							<hr>
						</div>
						...
						<div class="clear">
							...
							<div class="col-sm-5">
								<div class="form-group">
									<label for="firstname" style="text-align: center;"></label>
							...
							<div class="col-sm-6" style="text-align: center;">
								<div class="form-group">
									<button type="button" onclick="location.href='memberSignIn'"
										class="btn btn-primary">
										<i class="fa fa-envelope-o"></i> Individual Member<br>Register
									</button>
							...
							<div class="col-sm-6" style="text-align: center;">
								<div class="form-group">
									<button type="button" onclick="location.href='companySignIn'"
										class="btn btn-primary">
										<i class="fa fa-envelope-o"></i> Enterprise Member<br>Register
									</button>

		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1 profiel-container">
					...
					<form action="companyUpdate" method="post" enctype="multipart/form-data">
						<div class="profiel-header">
							<h3>
								<b>Update</b> Membership Profile <br> <small>This
						...
						<div class="clear">
							<div class="col-sm-3" style=" margin-left: 40px;">
								<div class="picture-container">
									<div class="picture" style="max-height: max-content;">
										<img src="showCompanyImg?co_id=${company.co_id}" class="picture-src" id="wizardPicturePreview" title=""/> <input type="file"
							...
							<div class="col-sm-7" style="width: 62.333333%;margin-top:  30px;">
                         		 <div class="row" style="margin-right: 40px;margin-left: 40px;width: 100%;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>Company ID </label><h3 style="margin-top: unset;">${company.co_id}</h3>	
									</div>
									<div class="col-md-5" style="width: 50%;">
										<label>Company Name <small>(required)</small></label> <input
										name="co_name" type="text" class="form-control"
										placeholder="Smith..." value="${company.co_name}">
								 	</div>
								</div>
								<div class="row" style="margin-right: 40px;margin-left: 40px;width:  100%;margin-top: 20px;">
							    	<div class="col-md-5" style="width: 50%;">
										...
										name="co_website" type="text" class="form-control" value="${company.co_website}">
																	</div>
									<div class="col-md-5" style="width: 50%;">
										<label>Company Password :<small>(required)</small></label> <input
										name="co_pwd" type="password" class="form-control" value="${company.co_pwd}"
										id="co_pwd1">
									</div>
								</div>
								...
								<div style="margin-right: 40px;margin-left: 40px;width:  100%;margin-top: 20px;">
								    <div class="col-md-5" style="width: 50%;">
										...
										type="text" name="co_phone" class="form-control" value="${company.co_phone}"> 
									</div>
							    	<div class="col-md-5" style="width: 50%;">
						...
						<div class="clear">
							...
							<br>
								<div class="row" style="margin-right: 40px;margin-left: 40px;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>CEO First Name :</label> <input name="co_ceo_firstname" value="Smith3333" type="text" class="form-control">
									</div>
									<div class="col-md-5" style="width: 50%;">
										<label>CEO Last Name :</label> <input name="co_ceo_lastname" value="Hello3333" type="text" class="form-control">
								 	</div>
								</div>
				               <div class="row" style="margin-right: 40px;margin-left: 40px; margin-top: 30px;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>CEO Email :</label> <input name="co_email" value="${company.co_email}"
										type="email" class="form-control">
									</div>
									<div class="col-md-5" style="width: 50%;">
										<label>Postal code / Zip code :</label> <input name="co_zipcode" value="${company.co_zipcode}"
				               ...
				               <div class="row" style="margin-right: 40px;margin-left: 40px; margin-top: 40px;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>Country :</label>
										<select value="${company.co_country}" name="co_country" class="select" id="info_country" style="padding-left: 10px;">
								...
								<div class="row" style="margin-right: 40px;margin-left: 40px; margin-top: 20px;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>State/ Province/Region :</label> <input name="co_province" placeholder="North Carolina" value="${company.co_province}"
										type="text" class="form-control">
								</div>
									<div class="col-md-5" style="width: 50%;">
										<label>City :</label> <input name="co_city" type="text" placeholder="Carrboro" value="${company.co_city}"
										class="form-control">
								</div>
								</div>
								<div class="row" style="margin-right: 40px;margin-left: 40px; margin-top: 30px;">
							    	<div class="col-md-5" style="width: 50%;">
										<label>Address1 :</label> <input name="co_address1" type="text" placeholder="370 East Main Street" value="${company.co_address1}"
										class="form-control">
								</div>
									<div class="col-md-5" style="width: 50%;">
										<label>Address2 :</label> <input name="co_address2" type="text" placeholder="Apartment 100" value="${company.co_address2}"
										class="form-control">
								</div>
								</div>
						</div>
						...
						<div class="profiel-header" style="text-align: center;">
							...
							<button type="submit" class="btn btn-default"
								onsubmit="return formcheck()">Update</button>
						<br>
						<br>
						</div>
					</form>
